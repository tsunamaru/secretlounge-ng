...
format_strs = {
	...
	types.ERR_NOT_IN_CACHE: em("Message not found in cache... (48h passed or bot was restarted)"),
	types.ERR_NO_USER: em("No user found by that name!"),
	types.ERR_NO_USER_BY_ID: em("No user found by that id! Note that all ids rotate every 48 hours."),
	...
	types.PROGRAM_VERSION: "secretlounge-ng [assthread edition] v{version} ~ https://github.com/tsunamaru/secretlounge-ng",
